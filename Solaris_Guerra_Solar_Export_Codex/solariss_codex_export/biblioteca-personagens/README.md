...
```txt
http://localhost:3000/?view=launcher&check=20260629a
```
...
A versao `0.6.0-alpha.24` inicia a **Fase 27B** com o novo launcher cinematografico e a tela de sessao redesenhada no estilo Foundry/Roll20: mapa dominante, menu circular de cenas, toolbar vertical compacta e painel lateral direito por abas para Bate-papo, Personagens, Combate e Itens. A Fase 27A continua preservando o mapa local **Nave Caida - Destrocos** em `assets/maps/nave-caida.png`.
...
- `docs/FASE_27B_REDESIGN_UI_LAUNCHER_MESA.md`

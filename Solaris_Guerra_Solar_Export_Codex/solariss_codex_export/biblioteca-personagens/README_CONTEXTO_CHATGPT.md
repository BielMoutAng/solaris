...
- O Electron VTT usa `?view=launcher&tabletop=1&check=20260629a` como entrada.
- O cache atual do runtime da Fase 27B e `20260629a`.
- A versao local do Tabletop passou para `0.6.0-alpha.24`.
- A versao `0.6.0-alpha.24` redesenha o launcher e a sessao da Mesa Virtual: launcher cinematografico, mapa dominante, menu circular de cenas, toolbar vertical e painel direito por abas para Bate-papo, Personagens, Combate e Itens.
- A Fase 27A continua preservada: `assets/maps/nave-caida.png` e usado como cena padrao **Nave Caida - Destrocos**, com grid 24x16 para salas novas sem cena explicita e para o modo offline/simulado.

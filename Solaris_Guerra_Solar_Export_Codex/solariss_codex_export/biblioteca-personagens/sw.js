const STATIC_CACHE = "solaris-biblioteca-static-20260613e";
const RUNTIME_CACHE = "solaris-biblioteca-runtime-20260613e";
...
const APP_SHELL = [
  ...
  "./official-book5-catalog.js?v=20260612a",
  "./official-rulebook-compendium.js?v=20260613a",

const STATIC_CACHE = "solaris-biblioteca-static-20260614j";
const RUNTIME_CACHE = "solaris-biblioteca-runtime-20260614j";
...
const APP_SHELL = [
  ...
  "./app.js?v=20260614j",
  "./src/domain/solaris-domain-architecture.js?v=20260614j",

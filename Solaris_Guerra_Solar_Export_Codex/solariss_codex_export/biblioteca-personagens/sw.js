const STATIC_CACHE = "solaris-biblioteca-static-20260615b";
const RUNTIME_CACHE = "solaris-biblioteca-runtime-20260615b";
...
const APP_SHELL = [
  ...
  "./app.js?v=20260615b",
  "./src/domain/solaris-domain-architecture.js?v=20260615b",

const STATIC_CACHE = "solaris-biblioteca-static-20260630d";
const RUNTIME_CACHE = "solaris-biblioteca-runtime-20260630d";

const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=20260630d",
  "./official-books-data.js?v=20260630d",
  "./official-book5-catalog.js?v=20260630d",
  "./official-rulebook-compendium.js?v=20260630d",
  "./HumanisVitalHUD.js?v=20260606e",
  "./app.js?v=20260630d",
  "./src/domain/solaris-domain-architecture.js?v=20260630d",
  "./src/domain/solaris-character-creation.js?v=20260630d",
  "./src/domain/solaris-combat-rules.js?v=20260630d",
  "./src/domain/solaris-equipment-rules.js?v=20260630d",
  "./src/domain/solaris-bestiary-rules.js?v=20260630d",
  "./src/domain/solaris-gm-rules.js?v=20260630d",
  "./src/domain/solaris-lore-rules.js?v=20260630d",
